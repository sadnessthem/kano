...
from PyQt5.QtWidgets import QSystemTrayIcon, QMenu, QAction, QDialog, QMessageBox, QApplication
...
class TrayManager:
    ...
    def __init__(self, window, bridge, config=None, behavior=None, services=None, pomodoro=None):
        self._window = window
        self._bridge = bridge
        self._config = config
    ...
    def _setup_tray(self):
        ...
        self._menu.addSeparator()
        todo_act = self._menu.addAction("📋 查看待办")
        todo_act.triggered.connect(self._show_todos)
